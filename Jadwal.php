...
$query = query("SELECT * FROM jadwal");
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">Jadwal Keberangkatan</a>
    ...
    <div id="container">
        <table class="table table-striped">
            ...
            <tbody>
                <?php $i = 1; ?>
                <?php foreach ($query as $jdwl) : ?>
                    <tr>
                        <td><?= $i; ?></td>
                        <td><?= $jdwl["namaSupir"]; ?></td>
                        <td><?= $jdwl["asalberangakt"]; ?></td>
                        <td><?= $jdwl["Tujuan"]; ?></td>
    ...
    <script src="js/scriptjdw.js"></script>
