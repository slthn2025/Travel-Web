...
$idData = query("SELECT * FROM penumpang WHERE Id = $id")[0];


if (isset($_POST["submit"])) {

    if (UbahPenumpang($_POST) > 0) {
        echo "
        <script>
...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        <a class="navbar-brand" href="#">Penumpang</a>
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nama" id="nama" value="<?= $idData["namaPenumpang"]; ?>">
        </div>
        ...
        <select class="form-control" id="jmlhK" name="jumlahKursi">
            <option><?= $idData["jumlahKursi"]; ?></option>
            <option>1</option>
            <option>2</option>
            <option>3</option>
            <option>4</option>
