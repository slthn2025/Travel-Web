...
if (isset($_POST["submit"])) {
    if (artikel($_POST) > 0) {
        echo "
        <script>
        alert('Terimakasih, artikel berhasil di post');
        document.location.href = 'artikelPost.php';
        </script>";
    } else {
        echo "
         <script>alert('artikel gagal di post');
        document.location.href = 'artikelPost.php';
        </script>";
    }
}
    ...
    <div class="parallax-content contact-content" id="contact-us">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="text">
                        <h1>Bagikan Cerita Anda Lewat Artikel </h1>
                        <p>Berikan Cerita Anda Tentang Penglaman anda berkeliling tampat wisata dan meng eksplore kebudayaan yang unik di indonesia</p>
                    </div>
                </div>
            </div>
        </div>
