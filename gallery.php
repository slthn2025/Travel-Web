...
<body>
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <form class="form-inline my-2 my-lg-0">
                <input class="form-control mr-sm-2" type="search" placeholder="Nama" name="search" id="search" aria-label="Search">
            </form>
    ...
    <div id="container">
        <table class="table table-striped">
            ...
            <tbody>
                <?php $i = 1; ?>
                <?php foreach ($query as $gl) : ?>
                    <tr>
                        <td><?= $i; ?></td>
                        <td><?= $gl["nama"]; ?></td>
                        <td><?= $gl["email"]; ?></td>
                        <td><?= $gl["message"]; ?></td>
                        <td><img src="../../img/<?= $gl["img"]; ?>" alt="" width="200px"></td>
                        <td>
                            <a href="hapusGallery.php?id=<?= $gl["id"]; ?>" class="btn btn-danger" onclick="return confirm('anda yakin? Data akan Di hapus')">Hapus</a>
                        </td>
                    </tr>
                    <?php $i++; ?>
                <?php endforeach; ?>
    ...
    <script src="js/scriptglr.js"></script>
