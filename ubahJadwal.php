...
<body>
    ...
    <form action="" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="nama" id="nama" value="<?= $idData["namaSupir"]; ?>">
        </div>
        <label for="exampleFormControlSelect1">Asal Berangkat</label>
        <select class="form-control" id="asal" name="asal">
            <option><?= $idData["asalberangakt"]; ?></option>
        ...
        <div class="form-group">
            <label for="formGroupExampleInput2">Nomor Armada</label>
            <input type="text" class="form-control" name="armada" id="armada" placeholder="Another input" value="<?= $idData["nomerArmada"]; ?>">
        </div>
        <div class="form-group">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="noHandphone" id="nohp" placeholder="Another input" value="<?= $idData["noHandphone"]; ?>">
        </div>
        <div class="form-group">
            <label for="formGroupExampleInput2">Tanggal Keberangkatan</label>
            <input type="date" class="form-control" name="tgl" id="tgl" placeholder="Another input" value="<?= $idData["tanggal"]; ?>">
        </div>
