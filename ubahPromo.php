...
$idData = query("SELECT * FROM promo WHERE id = $id")[0];
...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="msg" id="msg" value="<?= $idData["pesan"]; ?>">
        </div>
        <label for="gambar">Gambar</label></li>
        <img src="img/<?= $idData["img"]; ?>" width="220">
        <input type="file" name="gambar" id="gambar">

        <div class="modal-footer">
            <a href="promo.php" class="btn btn-danger">Batal</a>
